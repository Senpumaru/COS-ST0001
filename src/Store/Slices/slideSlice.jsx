...
export const resetSlides = () => async (dispatch) => {
...
export const createSlides = (instance) => async (dispatch) => {
  dispatch(CreateLoading());
  try {
    // Success
...
export const detailSlide = (uuid) => async (dispatch) => {
...
export const updateSlide = (instance) => async (dispatch) => {
